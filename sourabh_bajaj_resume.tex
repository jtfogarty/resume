...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://007ba7.us/}{\Large Jeff Fogarty}} & Email: \href{mailto:jeff@fogarty.org}{jeff@fogarty.us}\\
  \href{https://007ba7.us/}{007ba7.us} & Mobile: \href{tel:+13147532279}{+1-314-753-2279} \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Aviation Technology}{Sept 1983 -- Dec 1989}
    \resumeSubheading
      {Webster University}{Webster Groves, MO}
      {Computer Resource Management}{1997 -- 2000}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Azure Cloud Engineer}{2020 -- July 2024}
      \resumeItemListStart
    ...
    \resumeSubSubheading
     {Technology Architect}{2016 -- 2020}
     \resumeItemListStart
        \resumeItem{Apache Beam}
